    ...
    <div class="login-card">
      ...
      <el-form :model="loginForm" :rules="loginRules" ref="loginFormRef" class="login-form">
        ...
        <el-form-item prop="adminName">
          <el-input v-model="loginForm.adminName" placeholder="请输入用户名" size="large" :prefix-icon="User" clearable />
        </el-form-item>

        <!-- 密码输入 -->
        <el-form-item prop="adminPwd">
          <el-input v-model="loginForm.adminPwd" type="password" placeholder="请输入密码" size="large" :prefix-icon="Lock"
...
console.log("✅ 当前 AdminLogin.vue 已经加载！");
<script setup>
